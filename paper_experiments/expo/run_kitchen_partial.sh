...
#SBATCH --job-name=expo_kitchen_partial
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=100G
#SBATCH --time=100:00:00
#SBATCH --output=/scratch/sws0/user/ssaxena/logs/expo_kitchen_partial_%j.out
#SBATCH --error=/scratch/sws0/user/ssaxena/logs/expo_kitchen_partial_%j.out
...
seed=0
env_name="D4RL/kitchen/partial-v2"
run_name="expo_kitchen_partial_${seed}"
utd_ratio=20
start_training=5000
max_steps=3000000
