...
#SBATCH --job-name=expo_pusht_sparse
#SBATCH --gres=gpu:1
...
output_dir="/data/user_data/mananaga/expo/logs_sparse"
...
echo "Starting EXPO Push-T training job (SPARSE reward) on $(hostname) at $(date)"
