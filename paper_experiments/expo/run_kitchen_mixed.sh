...
#SBATCH --job-name=expo_kitchen_mixed
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=100G
#SBATCH --time=100:00:00
#SBATCH --output=/scratch/sws0/user/ssaxena/logs/expo_kitchen_mixed_%j.out
#SBATCH --error=/scratch/sws0/user/ssaxena/logs/expo_kitchen_mixed_%j.out
...
run_name="expo_kitchen_mixed_${seed}"
utd_ratio=20
start_training=5000
max_steps=3000000
